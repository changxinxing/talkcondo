...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<table class="table table-bordered table-striped shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
		<thead>
			<tr>
						...
						<td class="product-thumbnail">
							<?php
								...
								if ( ! $product_permalink ) {
									...
									printf( '<a href="%s" class="thumbnail">%s</a>', esc_url( $product_permalink ), $thumbnail );
								}
							?>
						</td>
